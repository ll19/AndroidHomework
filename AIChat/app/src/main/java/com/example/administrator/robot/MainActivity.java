...
//      设置布局管理
    ...
    private void initData() {
        Chat c1 = new Chat("小铃铛为您服务，请问有什么可以帮助您的吗", Chat.TYPE_RECEIVED);
        list.add(c1);
        Chat c2 = new Chat("今天天气如何？", Chat.TYPE_SENT);
        list.add(c2);
        Chat c3 = new Chat("今天气温26摄氏度，阴转晴，无暴雨预警", Chat.TYPE_RECEIVED);
        list.add(c3);
        Chat c4 = new Chat("华侨大学住宿情况如何？", Chat.TYPE_RECEIVED);
        list.add(c4);
    }
